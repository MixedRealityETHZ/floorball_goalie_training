...
public class CameraStreamHelper : MonoBehaviour
{
    ...
    public void SetNativeISpatialCoordinateSystemPtr(IntPtr ptr)
    {
        ...
        Debug.Log("Finished setting videoCapture.WorldOriginPtr");
    }
    ...
    public void GetVideoCaptureAsync(OnVideoCaptureResourceCreatedCallback onVideoCaptureAvailable)
    {
        ...
        Debug.Log("Finished getting VideoCaptureAsync");
    }
    ...
    private void Awake()
    {
        ...
        Debug.Log("VideoCapture created Async");
    }
    ...
    {
        Debug.Log("Dstarted VideoCaptureInstanceCreated");
        if (videoCapture == null)
        {
        ...
        Debug.Log("Finished VideoCaptureInstanceCreated");
    }
}
