...
## Demo
The demo presentation slides can also be found on [Polybox](https://polybox.ethz.ch/index.php/s/2eE2kAFLVHstTKe). We have also done a [more detailed demo video](https://polybox.ethz.ch/index.php/s/vR9JBhu69ky2Mbe), also including some improvements that have been made since the demo session (most notably increasing the framerate from about 6 to 15). This video will also be submitted.
